...
function addSecurityHeaders(response: NextResponse): void {
  ...
  response.headers.set(
    'Content-Security-Policy',
    "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https: https://*.mlstatic.com https://*.mercadolibre.com https://*.mercadolivre.com.br; font-src 'self' data:; connect-src 'self' https://api.mercadolibre.com https://api.mercadolivre.com.br https://auth.mercadolivre.com.br; frame-src 'self' https://*.mercadolibre.com https://*.mercadolivre.com.br; object-src 'none'; base-uri 'self';"
  );
